...
class UsageSnapshot(Base):
    ...
    total_bytes_up: Mapped[int] = mapped_column(
        BigInteger, nullable=False, default=0, server_default="0"
    )
    total_bytes_down: Mapped[int] = mapped_column(
        BigInteger, nullable=False, default=0, server_default="0"
    )
    voucher_uses: Mapped[int] = mapped_column(
        Integer, nullable=False, default=0, server_default="0"
    )
...
class BrandConfig(Base):
    ...
    hotel_name: Mapped[str] = mapped_column(
        String(200), nullable=False, default="Hotel WiFi", server_default="'Hotel WiFi'"
    )
    ...
    language: Mapped[LanguageType] = mapped_column(
        Enum(LanguageType, name="languagetype"), nullable=False, default=LanguageType.th
    )
...
class DhcpConfig(Base):
    ...
    interface: Mapped[str] = mapped_column(
        String(32), nullable=False, default="wlan0", server_default="'wlan0'"
    )
    ...
    subnet: Mapped[str] = mapped_column(
        ...
        server_default="'192.168.0.0/22'",
    )
    dhcp_range_start: Mapped[str] = mapped_column(
        String(15),
        nullable=False,
        default="192.168.0.10",
        server_default="'192.168.0.10'",
    )
    dhcp_range_end: Mapped[str] = mapped_column(
        String(15),
        nullable=False,
        default="192.168.3.250",
        server_default="'192.168.3.250'",
    )
    lease_time: Mapped[str] = mapped_column(
        String(12), nullable=False, default="8h", server_default="'8h'"
    )
    dns_upstream_1: Mapped[str] = mapped_column(
        String(45), nullable=False, default="8.8.8.8", server_default="'8.8.8.8'"
    )
    dns_upstream_2: Mapped[str] = mapped_column(
        String(45), nullable=False, default="8.8.4.4", server_default="'8.8.4.4'"
    )
    dns_mode: Mapped[DnsModeType] = mapped_column(
        Enum(DnsModeType, name="dnsmodetype"),
        nullable=False,
        default=DnsModeType.redirect,
    )
